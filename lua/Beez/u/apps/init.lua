...
M.render_markdown = require("Beez.u.apps.render_markdown")
M.snacks = require("Beez.u.apps.snacks")
M.treesitter = require("Beez.u.apps.treesitter")
M.keymaps = require("Beez.u.apps.keymaps")
M.lazy = require("Beez.u.apps.lazyvim")
